...
contextBridge.exposeInMainWorld('api', {
  ...
  ai: {
    ...
    generateSummary: (content, interviewType) => ipcRenderer.invoke('ai:generateSummary', content, interviewType),
    extractKeyFindings: (content, projectName, interviewType) => ipcRenderer.invoke('ai:extractKeyFindings', content, projectName, interviewType),
    extractRiskIndicators: (content, projectName, interviewType) => ipcRenderer.invoke('ai:extractRiskIndicators', content, projectName, interviewType),
