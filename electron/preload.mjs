...
contextBridge.exposeInMainWorld('api', {
  ...
  ai: {
    ...
    generateSummary: (content) => ipcRenderer.invoke('ai:generateSummary', content),
    extractKeyFindings: (content, projectName) => ipcRenderer.invoke('ai:extractKeyFindings', content, projectName),
    extractRiskIndicators: (content, projectName) => ipcRenderer.invoke('ai:extractRiskIndicators', content, projectName),
